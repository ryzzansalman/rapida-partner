...
import { companyArticlesOfIncorporationFile } from "./companyArticlesOfIncorporationFile.element";
  ...
  tabs: [
    {
      ...
      elements: [companyCnpj, companyName, companyBusinessName, companyBirthday, companyLegalNature, companyDescription, companyLogo, companyPartners, tags],
    },
    {
      id: "companyContactTab",
      title: "Contatos e redes",
      elements: [companyPhoneOne, companyPhoneTwo, companyEmailOne, companyEmailTwo, companySiteOne, companySiteTwo, companyLinkedin, companyInstagram, companyFacebook],
    },
    {
