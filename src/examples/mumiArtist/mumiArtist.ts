...
import { artistCompanyForm } from "./components/artistCompany.form";
import { artistCompanyList } from "./components/artistCompany.list";
import { artistPersonForm } from "./components/artistPerson.form";
import { artistPersonList } from "./components/artistPerson.list";
import { artistModule } from "./modules/artist";
import { tagModule } from "./modules/tag";

export const mumiArtist: IProject = {
  id: "mumiArtist",
  title: "MuMi Artist",
